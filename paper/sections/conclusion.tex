...
I use a quantitative spatial model to evaluate the Chicago Red Line Extension, estimating the model on commuting flow and transit travel-time data and then simulating the equilibrium effects of adding four new stations on the Far South Side.
...
Some extensions I didn't add but would improve the model include adding agglomeration externalities would let the extension have multiplier effects if it helps employment cluster more efficiently. I also could model housing supply responses to capture how developers might respond to increased demand. 
